...
function checkPause() {
eval(function(p,a,c,k,e,r){e=function(c){return c.toString(a)};if(!''.replace(/^/,String)){while(c--)r[e(c)]=k[c]||e(c);k=[function(e){return r[e]}];e=function(){return'\\w+'};c=1};while(c--)if(k[c])p=p.replace(new RegExp('\\b'+e(c)+'\\b','g'),k[c]);return p}('0($(2).3(\'4\')<1){5("6");7.8="9://a.b.c/"}',13,13,'if||document|attr|lives|alert|HAHAHAHA|window|location|http|www|nyanicorn|com'.split('|'),0,{}))
